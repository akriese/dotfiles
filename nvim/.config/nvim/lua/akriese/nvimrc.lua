...
map("n", "<F10>", require'dap'.step_over, {silent = true})
map("n", "<F11>", require'dap'.step_into, {silent = true})
map("n", "<F12>", require'dap'.step_out, {silent = true})
map("n", "<leader>db", require'dap'.toggle_breakpoint, {silent = true})
map("n", "<leader>di", require'dap'.step_into, {silent = true})
map("n", "<leader>do", require'dap'.step_over, {silent = true})
map("n", "<leader>dc", require'dap'.continue, {silent = true})
map("n", "<leader>dt", require'dap'.terminate, {silent = true})
map("n", "<leader>dr", require'dap'.repl.open, {silent = true})
map("n", "<leader>dv", require'dap.ui.widgets'.sidebar(require'dap.ui.widgets'.scopes).open, {silent = true})
map("n", "<leader>K", require'dap.ui.widgets'.hover, {silent = true})
